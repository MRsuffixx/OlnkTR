...
function setAtPath(value: AppearanceSettings, path: AppearanceFeaturePath, next: unknown) {
...
export function isAppearanceValueAllowed(path: AppearanceFeaturePath, value: unknown, pro: boolean) {
  if (pro) return true;
...
export function mergePermittedAppearance(incoming: unknown, stored: unknown, pro: boolean) {
