...
export const env = createEnv({
  server: {
    ...
    PAYTR_TEST_MODE: z.enum(["0", "1"]).optional(),
    PAYTR_LIVE_MODE_ACKNOWLEDGED: z.enum(["true", "false"]).default("false"),
  ...
  runtimeEnv: {
    ...
    PAYTR_LIVE_MODE_ACKNOWLEDGED: process.env.PAYTR_LIVE_MODE_ACKNOWLEDGED,
